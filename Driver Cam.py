...
label.pack(side=TOP)
filename = PhotoImage(file="C:/Users/kotap/Documents/Drowsiness-monitoring-Using-OpenCV-Python-master/Drowsiness-monitoring-Using-OpenCV-Python-master/demo.png")
...
def webdet():
   capture =cv2.VideoCapture(0)
   face_cascade = cv2.CascadeClassifier('C:/Users/kotap/Documents/Drowsiness-monitoring-Using-OpenCV-Python-master/Drowsiness-monitoring-Using-OpenCV-Python-master/lbpcascade_frontalface.xml')
   eye_glass = cv2.CascadeClassifier('C:/Users/kotap/Documents/Drowsiness-monitoring-Using-OpenCV-Python-master/Drowsiness-monitoring-Using-OpenCV-Python-master/haarcascade_eye_tree_eyeglasses.xml')
...
def alert():
   mixer.init()
   alert=mixer.Sound('C:/Users/kotap/Documents/Drowsiness-monitoring-Using-OpenCV-Python-master/Drowsiness-monitoring-Using-OpenCV-Python-master/beep-07.wav')
   alert.play()
   time.sleep(0.1)
   alert.play()   
...
def blink():
   capture =cv2.VideoCapture(0)
   face_cascade = cv2.CascadeClassifier('C:/Users/kotap/Documents/Drowsiness-monitoring-Using-OpenCV-Python-master/Drowsiness-monitoring-Using-OpenCV-Python-master/lbpcascade_frontalface.xml')
   eye_cascade = cv2.CascadeClassifier('C:/Users/kotap/Documents/Drowsiness-monitoring-Using-OpenCV-Python-master/Drowsiness-monitoring-Using-OpenCV-Python-master/haarcascade_eye.xml')
   blink_cascade = cv2.CascadeClassifier('C:/Users/kotap/Documents/Drowsiness-monitoring-Using-OpenCV-Python-master/Drowsiness-monitoring-Using-OpenCV-Python-master/CustomBlinkCascade.xml')
